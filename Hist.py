...
def main():
	...
	parser.add_argument('--bins', '-b', metavar='BINS', required=False, dest='binsize', type=int, default=75, help='Number of bins in output image')
	
	parser.add_argument('--color', '-c', metavar='COLOR', required=False, dest='colour', type=str, default='#7D7D7D', help='Color of output histogram')
	...
	pl.hist(x, bins=args.binsize,color=args.colour,label=args.label)
